...
print(f'| QUEUED  | {len(singlen_queued):<6}| {total_sn_q:<6}| {100*total_sn_q/curr_cap_nodes:<5.1f} %  |   {len(multiplen_queued):<5}| {total_mn_q:<6}| {100*total_mn_q/curr_cap_nodes:<5.1f} % |')
print(f'-----------------------------------------------------------------\n')
